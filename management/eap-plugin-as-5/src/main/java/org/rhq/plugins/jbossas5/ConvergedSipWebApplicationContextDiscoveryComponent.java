 ...
 * @author Ian Springer
 */
public class ConvergedSipWebApplicationContextDiscoveryComponent
        implements ResourceDiscoveryComponent<AbstractManagedDeploymentComponent>
{
    ...
    private static final String CONVERGED_SIP_WEB_APPLICATION_MANAGER_COMPONENT_NAME_TEMPLATE =
            "jboss.web:host=%" + WebApplicationContextComponent.VIRTUAL_HOST_PROPERTY + "%,"
                    + "path=%" + WebApplicationContextComponent.CONTEXT_PATH_PROPERTY + "%,type=SipManager"; // TODO check cluster case
            ...
            ResourceDiscoveryContext<AbstractManagedDeploymentComponent> discoveryContext) throws Exception
    {
        ...
        for (ManagedComponent webApplicationComponent : webApplicationComponents)
        {
            ...
            String webApplicationManagerComponentName =
                    ResourceComponentUtils.replacePropertyExpressionsInTemplate(CONVERGED_SIP_WEB_APPLICATION_MANAGER_COMPONENT_NAME_TEMPLATE,
                            pluginConfig);
