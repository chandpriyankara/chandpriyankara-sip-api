...
@JBossXmlSchema(
      ...
      normalizeSpace=true)
@XmlType(name="jboss-webType", namespace="", propOrder={"classLoading", "securityDomainWeb", "jaccAllStoreRole", "contextRoot",
...
public class EAP50DTDConvergedSipMetaData extends JBossConvergedSipMetaData
{
