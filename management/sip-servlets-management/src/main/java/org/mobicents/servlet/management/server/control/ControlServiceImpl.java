...
package org.mobicents.servlet.management.server.control;
...
import org.mobicents.servlet.management.client.control.ControlService;

import com.google.gwt.user.server.rpc.RemoteServiceServlet;

public class ControlServiceImpl  extends RemoteServiceServlet implements ControlService {
	...
	public void stopGracefully(long timeToWait) {
		try {
			...
			mserver.invoke(dispatcherName, "stopGracefully", new Object[]{timeToWait}, new String[]{"long"});
		} catch (Throwable t) {
